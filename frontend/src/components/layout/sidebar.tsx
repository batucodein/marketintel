...
import { LayoutDashboard, Search, Globe, DollarSign, Settings, Mail, FlaskConical } from "lucide-react";
  ...
  return (
    <aside className="hidden lg:flex w-60 flex-col border-r border-border bg-card">
      <div className="flex h-14 items-center px-6 border-b border-border">
        <Link href="/" className="text-lg font-bold text-primary font-mono">
          MarketIntel
        </Link>
      </div>
